    ...
    <EmasLayout>
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-black text-gray-900">Add New Subject</h1>
                    <p class="text-sm text-gray-600 mt-1">Create a new examination subject</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="rounded-xl bg-white p-8 shadow-lg border-2 border-gray-200">
                ...
                <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-200 mt-6">
                    ...
                    <button
                        ...
                        class="rounded-lg bg-emerald-600 hover:bg-emerald-700 px-6 py-2.5 text-white font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
